import { FormValidator, ValidationType, ValidationSpecs, ModelFieldError, ModelErrors } from ".";
...
describe("Form Validator", () => {
    ...
    describe("Testing each validation type individually", () => {
        const testCases: Array<TestCase1> = [
            ...
            { type: "isDate", value: "abc", expected: { errorCode: "invalidDate" } },
            ...
            { type: "dateRange", value: null, specs: { maxDate: now }, expected: noError },
            { type: "textLength", value: null, specs: { minLength: 5 }, expected: noError },
            { type: "valueRange", value: null, specs: { minValue: 5 }, expected: noError },
